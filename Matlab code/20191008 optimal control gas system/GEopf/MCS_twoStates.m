function [Info_twostateplant] = MCS_twoStates(mission_time,unitNumber,lamda_unit,Mu_unit)
...
twostateplant_rates = [lamda_unit * (unitNumber:-1:0)', Mu_unit * (0:unitNumber)'];
%     twostateplant_rates = [lamda_unit, 0;
%                             0, Mu_unit]; 


twostateplant_state  =  unitNumber:-1:0;    %% Represent how many units are available for each state 
...
Info_twostateplant(1,4)= twostateplant_state(1);    %% capacity in this state 
Total_Dur = 0;
iter =1;
