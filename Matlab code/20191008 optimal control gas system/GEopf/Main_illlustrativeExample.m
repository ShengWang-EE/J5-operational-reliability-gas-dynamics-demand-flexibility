...
%     predetermine the time step for each scenario
    ...
    for j = 1:numberOfStates
        ...
        nt(j) = floor(duration*3600 / 200) + 1;%keep the time steps around 1h
...
%
    ...
    [reliabilityForOnesimulation] = obtainReliabilityIndicesForOneSimulation(InfoReliability,numberOfPeriods,missionTime);
    % counts the reliability indices for bigger loop
    allReliabilityIndices(:,3:6,i) = reliabilityForOnesimulation(:,3:6); % fit two demenssion into three demenssion    
