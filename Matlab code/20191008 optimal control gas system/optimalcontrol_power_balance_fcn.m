function [g,dg] = optimalcontrol_power_balance_fcn(Va0, Vm0, Pg0, Qg0, mpc, Ybus, mpopt,NK)
...
for k = 1:NK
    ...
    Pg = Pg0(k,:)';
    Qg = Qg0(k,:)';
    [g(k,:)] = opf_power_balance_fcn(Va, Vm, Pg, Qg, mpc, Ybus, mpopt)';
...
%% 
function [g, dg] = opf_power_balance_fcn(Va, Vm, Pg, Qg, mpc, Ybus, mpopt)
%%----- initialize -----
