function [h] = optimalcontrol_branch_flow_fcn(Vr0,Vi0, mpc, Yf, Yt, il, mpopt,NK)
for k = 1:NK
    Vr = Vr0(k,:)'; Vi = Vi0(k,:)';
    [h(k,:)] = opf_branch_flow_fcn(Vr,Vi, mpc, Yf, Yt, il, mpopt)';
%     [~,dh{k}] = opf_branch_flow_fcn(Va,Vm, mpc, Yf, Yt, il, mpopt);
end
end
...
function [h, dh] = opf_branch_flow_fcn(Vr,Vi, mpc, Yf, Yt, il, mpopt)
%%----- initialize -----
